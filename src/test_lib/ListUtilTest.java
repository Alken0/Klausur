...
public class ListUtilTest {
	...
	public void shuffle() {
		...
		for (int i = 0; i < 10; i++) {
			var firstElement = ListUtil.shuffle(input).get(0);
	...
	public void reverse() {
		...
		var result = ListUtil.reverse(input);
	...
	public void sortNoParameter() {
		var input = Arrays.asList(5, 3, 1, 2, 4);
		var result = ListUtil.sort(input);
	...
	public void sortWithCompareFunction() {
		...
		var result = ListUtil.sort(input, String::length);
	...
	public void filter() {
		...
		var result = ListUtil.filter(input, i -> i < 5);
